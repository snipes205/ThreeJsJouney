...
// reduce rendering resource to get better result
...
const rectAreaLight = new THREE.RectAreaLight(0xffffff,0.7,2,2);
...
// change shadowmap type
// Default
// renderer.shadowMap.type = THREE.PCFShadowMap;
// no radius but better perfomance
...
const tick = () =>
{
    ...
    // // move shpere
    // const moveX =  Math.cos(elapsedTime);
    // const moveZ =  Math.sin(elapsedTime);
    // //bouncing animation
    // const moveY =  Math.abs(Math.sin(elapsedTime * 3 )) ;
    ...
    // sphereShadow.position.x = moveX;
    // sphereShadow.position.z = moveZ;
    // // changing shadow
